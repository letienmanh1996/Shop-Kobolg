                            ...
                            <div class="card-body">
                                <form action="EditCategoryServlet" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img width="300" height="300" src="${category.img}"/>
                                        <input type="text" name="img" value="${category.img}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter name">
                                        <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Description</label>
                                        <input type="text" name="description" value="${category.desc}" class="form-control" id="exampleInputPassword1" placeholder="Description">
                                    </div>
