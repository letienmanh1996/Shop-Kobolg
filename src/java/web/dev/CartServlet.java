...
public class CartServlet extends BaseServlet {
    ...
    private void createOrder(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        OrderDetailSession orderDetailSession = new OrderDetailSession(productId,
                product.getName(), product.getImg(),
        ...
        if (cart == null) {
            ...
            //Ton tai session gio hang. Thuc hien tim kiem san pham da co trong gio hang chua
